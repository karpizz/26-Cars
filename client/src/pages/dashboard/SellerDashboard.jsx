...
export function SellerDashboard() {
  ...
  const { role, username, updateCars, cars, carTypes } = useContext(GlobalContext);
  ...
  return (
    <div className="container">
      ...
      <h2 className='mt-5 border-bottom'>Sell a car</h2>
      <button onClick={() => setShowForm(!showForm)} className='btn btn-primary rounded-pill px-3 my-2'>Add car for sale</button>
      <div className="col-2 my-3">
        ...
        <div className="col-2 my-3">
          <input onChange={e => setSearchTitle(e.target.value)} value={searchTitle} type="text" name="searchTitle" id="searchTitle" />
        </div>
      </div>
