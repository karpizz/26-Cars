  ...
  return (
    <div className="container my-5">
      <div className="row">
        ...
        <div className="d-flex justify-content-end col-auto col-lg-5 col-md-6 col-sm-12">
        ...
        <div className="col-12 col-lg-7 col-xl-6 col-md-6 col-sm-12">
          <div className="py-5">
            ...
            <form onSubmit={submitHandler}>
              ...
              <Link className="mt-4 btn btn-danger mx-1" to='/profile'>Cancel</Link>
            </form>
          </div>
        </div>
      </div>
